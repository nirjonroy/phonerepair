...
<!--chartjs js-->
<script src="{{asset('backend/assets/js/chart/flot-chart/excanvas.js')}}"></script>
<script src="{{asset('backend/assets/js/chart/flot-chart/jquery.flot.js')}}"></script>
<script src="{{asset('backend/assets/js/chart/flot-chart/jquery.flot.time.js')}}"></script>
<script src="{{asset('backend/assets/js/chart/flot-chart/jquery.flot.categories.js')}}"></script>
<script src="{{asset('backend/assets/js/chart/flot-chart/jquery.flot.stack.js')}}"></script>
<script src="{{asset('backend/assets/js/chart/flot-chart/jquery.flot.pie.js')}}"></script>
<!--dashboard custom js-->
...
<!--height equal js-->
<script src="{{asset('backend/assets/js/equal-height.js')}}"></script>
