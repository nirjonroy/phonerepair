                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade active show" id="account" role="tabpanel" aria-labelledby="account-tab">
                            <form action="{{route('reason.update', $reason->id)}}" class="needs-validation user-add" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="description-sm">
                                   <input type="title" name="title" id="" value="{{$reason->title}}" class="form-control">
                                </div>
                                </div>
                                ...
                                <div class="description-sm">
                                   <textarea id="" name="text" cols="100" rows="4">{{$reason->text}}</textarea>
                                </div>
                                </div>
